# -*- coding: utf-8 -*-
"""
Created on Sat Apr 13 23:06:18 2019
...
#third plot with different columns and grids and paraeter grids are how much we want to give error rate to the test and we tryto see with all of them
